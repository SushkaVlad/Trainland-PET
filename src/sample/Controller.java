...
public class Controller {
    ...
    void initialize() {
        ...
        Image i1 = new Image("sample/assets/captcha1.png");
        Image i2 = new Image("sample/assets/captcha2.png");
        Image i3 = new Image("sample/assets/captcha3.png");
        Image i4 = new Image("sample/assets/captcha4.png");
        Image i5 = new Image("sample/assets/captcha5.png");
        Image i6 = new Image("sample/assets/captcha6.png");
        Image i7 = new Image("sample/assets/captcha7.png");
        Image i8 = new Image("sample/assets/captcha8.png");
        ...
        }//подгружаем страницу наблюдения за поездами
        ...
        }//подгружаем страницу регистрации пользователя
        ...
        }//подгружаем страницу покупки билетов
        ...
        });//нажатие на кнопку регистрация(переход на страницу регистрации)
    ...
    private int log_in_user(String loginText, String passwordText) throws SQLException {
        ...
        if (!loginText.equals("admin1"))
       {
        ...
        return 0;
        }//функция, которая в случае попытки входа в качестве администратора возвращает - 2,
    // в случае простого пользователя - 1, в случае ошибки - 0
